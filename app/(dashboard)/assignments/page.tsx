...
import { getAssignments } from "@/lib/actions/assignment.action";
import { getClasses } from "@/lib/actions/class.action";
import { getSubjects } from "@/lib/actions/subject.action";

const AssignmentsPage = async ({ searchParams }: RouteParams) => {
  ...
  return (
    <div className="container mx-auto mt-16 flex flex-col gap-4 p-10">
      ...
      <AssignmentsTable role={session.user.role} data={result.data!} />
    </div>
  );
};
